import { Image, Button, Heading, Flex, InputRightElement, InputGroup, Input, TabPanels, TabPanel, Box, TabList, Tab, Tabs, Text } from '@chakra-ui/react';
        ...
        <>
            ...
            <Box>
                <Box bg="yellow.50" py={{ md: "50px", base: "20px" }}>
                    <Flex overflowX="scroll" alignItems="center" flexDirection={{ md: "row", base: "column" }}>
                        <Flex
                            gap="40px"
                            w="830px"
                            flex={1}
                        ...
                        >
                            ...
                            <Tabs
                                variant="enclosed" // Changed to a valid Chakra variant
                                as={Flex}
                                ml={{ md: "20px", base: "0px" }}
                                gap="38px"
                                display="flex"
                                                ...
                                                <Flex gap="24px" flexDirection="column">
                                                    <Flex gap="20px" flexDirection="column">
                                                        <InputGroup>
                                                            ...
                                                            />
                                                            <InputRightElement>
                                                                <Image src="images/img_linkedin.svg" alt="Linkedin" h="20px" mb="4px" />
                                                            </InputRightElement>
                                                        </InputGroup>
                                                        <Flex
                                                        ...
                                                        >
                                                            ...
                                                            <Image src="images/img_arrow_down.svg" alt="Arrow Down" h="20px" w="20px" />
                                                        </Flex>
                                                        <Flex
                                                            borderColor="blue_gray.100_01"
                                                            borderWidth="1px"
                                                    ...
                                                    <Button size="lg" fontWeight={700} alignSelf="stretch" borderRadius="10px">
                                                        Search
                                                    </Button>
                                                </Flex>
                                            </Box>
